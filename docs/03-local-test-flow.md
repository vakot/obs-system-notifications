...
The result should show AppID `OBS.SystemNotifications`. The shortcut is user-local and is recreated by the plugin when notifications initialize. Remove it only when you intentionally want to reset the local toast identity:
